...
<div class="container py-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h2 fw-bold mb-2">Tableau de bord Vendeur</h1>
            <p class="text-muted">Gérez vos produits et suivez vos performances</p>
        </div>
    </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title mb-1">Chiffre d'affaires</h6>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title mb-1">Total Commandes</h6>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0">{{ number_format($monthlyRevenue ?? 0, 2) }} DH</h3>
                        </div>
                ...
                <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between p-3 border-bottom">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('products.show', $product) }}" class="btn btn-outline-info btn-sm" title="Voir">
